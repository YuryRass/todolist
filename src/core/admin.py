...
class UserAdmin(BaseUserAdmin):
    # Какие поля отображаются на странице списка для изменения
    ...
    # Какие блоки полей будут отображаться на странице редактирования объекта
    # в административной панели, разбивая их по категориям
    fieldsets = (
